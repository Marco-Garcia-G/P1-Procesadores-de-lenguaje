P3 OPCIONAL - Generacion de codigo intermedio Lava
...
Ejecucion:
- Analisis lexico, sintactico y semantico previo:
  python3 main.py <fichero.lava>
- Modo lexer opcional heredado de P1:
  python3 main.py --token <fichero.lava>
- Generacion opcional de codigo intermedio:
  python3 main.py --ir <fichero.lava>
...
- El modo --ir solo genera el fichero .ir si el programa no tiene errores.

Objetivo de esta entrega:
- Esta carpeta corresponde a la entrega separada de codigo intermedio.
- Reutiliza el analizador semantico para no generar IR de programas invalidos.
- La salida se escribe en un fichero con la misma ruta base y extension .ir.
